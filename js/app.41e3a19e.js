                ...
                data: function () {
                    return {
                        ...
                        commands: {
                            ...
                            about: function () {
                                return N(
                                    "\n        &nbsp;<span class='ef'>Assalamualaikum,Greetings! I am a Computer Science and Engineering graduate specializing in full-stack web development with proficiency in the Laravel framework. Currently, I am pursuing my M.Sc. in Computer Science and Engineering from Jahangirnagar University while actively contributing as a Software Engineer at Lucrative IT. With over one year of professional experience in Laravel Framework, I am deeply passionate about technology and remain committed to staying abreast of the latest industry trends and emerging technologies. Approaching coding with fervor, I consistently deliver reliable and high-quality work. My dedication to providing exceptional solutions renders me a valuable asset in any development project.♓</span><br>\n        &nbsp;<b class='cd'>Exp:</b> <span class='ef'>1+ Years</span><br>\n        &nbsp;<b class='cd'>Skills:</b> <span class='ef'>PHP, Laravel, MysQl, Js, jQuery, Ajax, Node Js, Express Js, Bootstrap ..</span><br>\n        &nbsp;<b class='cd'>Working:</b> <span class='ef'>I’m currently working on Laravel</span><br>\n        &nbsp;<b class='cd'>Tools:</b> <span class='ef'>VsCode, PhpStorm, Postman, Git, GitHub  ..</span><br>\n        &nbsp;<b class='cd'>Learning:</b> <span class='ef'>I’m currently learning Laravel & Vue js</span><br>\n        &nbsp;<b class='cd'>Ask?:</b> <span class='ef'>Ask me about #Laravel #PHP #MySQL ..</span><br>\n        &nbsp;<b class='cd'>Hobby:</b> <span class='ef'>Coding, Reading Books, Travelling..</span><br>\n      "
                                );
                            },
                            contact: function () {
                                return N(
